...
namespace Presenter
{
	public partial class Window1
	{
        ...
        void presentation_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            if (e.PropertyName == "CurrentSlide")
            {
                if (presentation.CurrentSlide == "02Welcome.xaml")
                {
                    back.Visibility = Visibility.Hidden;
                    forw.Visibility = Visibility.Hidden;
                }
                else
                {
                    back.Visibility = Visibility.Visible;
                    forw.Visibility = Visibility.Visible;
                }
            }
        }
