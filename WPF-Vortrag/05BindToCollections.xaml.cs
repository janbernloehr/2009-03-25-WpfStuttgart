...
namespace Presenter
{
	public partial class BindToCollections
	{
        ...
        private void AddPlanetX(object sender, RoutedEventArgs e)
        {
            ...
            system.SolarSystemObjects.Add(
                new SolarSystemObject("Planet X", 
                    3, 
                    50000, 
                    new Uri(@"Images\planetx.jpg", UriKind.Relative), 
                    "This planet inhabited by aliens is cloaked so that humans can't see it."));
        }  
	}
}